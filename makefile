...
SNOOPY_INVALIDATE_COMMAND_SOURCE_DIRECTORY = $(SNOOPY_INVALIDATE_SOURCE_DIRECTORY)/commands
SNOOPY_INVALIDATE_COMMAND_INCLUDES				 = $(SNOOPY_INVALIDATE_COMMAND_SOURCE_DIRECTORY)/commands.sv \
																						 $(SNOOPY_INVALIDATE_COMMAND_SOURCE_DIRECTORY)/commandInterface.sv
...
SNOOPY_INVALIDATE_CACHE_CONTROLLER_CPU_CONTROLLER_TEST_INCLUDES					= $(SNOOPY_INVALIDATE_CACHE_CONTROLLER_VERIFICATION_INCLUDES)
SNOOPY_INVALIDATE_CACHE_CONTROLLER_CPU_CONTROLLER_TEST_IMPLEMENTATION = $(SNOOPY_INVALIDATE_CACHE_CONTROLLER_CPU_CONTROLLER_TEST_SOURCE_DIRECTORY)/testInterface.sv \
...
snoopy_invalidate_cache_controller_cpu_controller_test : $(SNOOPY_INVALIDATE_CACHE_CONTROLLER_CPU_CONTROLLER_TEST_INCLUDES) \
																							 					 $(SNOOPY_INVALIDATE_CACHE_CONTROLLER_CPU_CONTROLLER_TEST_IMPLEMENTATION)
	$(UVM_COMMAND) $? && $(MODELSIM_VERIFICATION_COMMAND)
...
SNOOPY_INVALIDATE_CACHE_CONTROLLER_SNOOPY_CONTROLLER_TEST_INCLUDES         = $(SNOOPY_INVALIDATE_CACHE_CONTROLLER_VERIFICATION_INCLUDES)
SNOOPY_INVALIDATE_CACHE_CONTROLLER_SNOOPY_CONTROLLER_TEST_IMPLEMENTATION   = \
	$(SNOOPY_INVALIDATE_CACHE_CONTROLLER_SNOOPY_CONTROLLER_TEST_SOURCE_DIRECTORY)/testInterface.sv \
...
SNOOPY_INVALIDATE_CACHE_CONTROLLER_CONCURRENCY_TEST_INCLUDES         = $(SNOOPY_INVALIDATE_CACHE_CONTROLLER_VERIFICATION_INCLUDES)
SNOOPY_INVALIDATE_CACHE_CONTROLLER_CONCURRENCY_TEST_IMPLEMENTATION   = $(SNOOPY_INVALIDATE_CACHE_CONTROLLER_CONCURRENCY_TEST_SOURCE_DIRECTORY)/cases.sv \
...
snoopy_invalidate_cache_controller_concurrency_test : $(SNOOPY_INVALIDATE_CACHE_CONTROLLER_CONCURRENCY_TEST_INCLUDES) \
																							 			 	$(SNOOPY_INVALIDATE_CACHE_CONTROLLER_CONCURRENCY_TEST_IMPLEMENTATION)
	$(UVM_COMMAND) $? && $(MODELSIM_VERIFICATION_COMMAND)
