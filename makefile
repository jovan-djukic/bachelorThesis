...
SNOOPY_INVALIDATE_OPERATING_UNIT_SOURCE_DIRECTORY = $(SNOOPY_INVALIDATE_SOURCE_DIRECTORY)/operatingUnit
SNOOPY_INVALIDATE_OPERATING_UNIT_IMPLEMENTATION   = $(SNOOPY_INVALIDATE_OPERATING_UNIT_SOURCE_DIRECTORY)/*.sv

#Replacement algorithm implementation
INVALIDATE_REPLACEMENT_ALGORITHM_SOURCE_DIRECTORY	= $(SNOOPY_INVALIDATE_OPERATING_UNIT_SOURCE_DIRECTORY)/replacementAlgorithm
...
SNOOPY_INVALIDATE_DIRECT_MAPPING_CACHE_UNIT_SOURCE_DIRECTORY = $(SNOOPY_INVALIDATE_OPERATING_UNIT_SOURCE_DIRECTORY)/directMappingCacheUnit
SNOOPY_INVALIDATE_DIRECT_MAPPING_CACHE_UNIT_IMPLEMENTATION   = $(SNOOPY_INVALIDATE_OPERATING_UNIT_IMPLEMENTATION) \
...
SNOOPY_INVALIDATE_SET_ASSOCIATIVE_CACHE_SOURCE_DIRECTORY 		 = $(SNOOPY_INVALIDATE_OPERATING_UNIT_SOURCE_DIRECTORY)/setAssociativeCacheUnit
