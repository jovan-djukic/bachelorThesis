...
VSIM = vsim
VERIFICATION_COMMAND = $(VSIM) -c bachelorThesis.TestBench -do "run -all"
...
lru_verification		: $(LRU_VERIFICATION)
	$(UVM_COMMAND) $(LRU_VERIFICATION) && $(VERIFICATION_COMMAND)
...
ram_verification : $(RAM_VERIFICATION)
	$(UVM_COMMAND) $(RAM_VERIFICATION) && $(VERIFICATION_COMMAND)
...
tag_memory_verification	:	$(TAG_MEMORY_VERIFIACTION)
	$(UVM_COMMAND) $(TAG_MEMORY_VERIFIACTION) && $(VERIFICATION_COMMAND)
