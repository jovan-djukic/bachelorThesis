...
VSIM                            = vsim -c bachelorThesis.TestBench
MODELSIM_IMPLEMENTATION_COMMAND = $(VSIM) -do "exit"
MODELSIM_VERIFICATION_COMMAND   = $(MODELSIM_IMPLEMENTATION_COMMAND) -do "run -all"
...
set_associative_cache_implementation : $(SET_ASSOCIATIVE_CACHE_IMPLEMENTATION)
	$(VLOG) $(SET_ASSOCIATIVE_CACHE_IMPLEMENTATION) && $(MODELSIM_IMPLEMENTATION_COMMAND)
